...
const CACHE_NAME = "DITY: Fred's Slots-cache";
const OFFLINE_URL = "DITY: Fred's Slots.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["DITY: Fred's Slots.html","DITY: Fred's Slots.js","DITY: Fred's Slots.wasm","DITY: Fred's Slots.pck","DITY: Fred's Slots.offline.html","DITY: Fred's Slots.icon.png","DITY: Fred's Slots.apple-touch-icon.png"];
